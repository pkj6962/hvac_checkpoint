...
MERCURY_GEN_PROC(hvac_open_in_t, ((hg_string_t)(path))((int32_t)(client_rank))((int32_t)(localfd))((int32_t)(flag))((int64_t)(start)))
...
string hvac_get_drampath(string path);
